...
EncButton enc(encA, encB, encBtn);
...
MENU(mainMenu,"Main menu",doNothing,noEvent,wrapStyle
  ,FIELD(timeOn,"On","ms",0,100,10,1,doNothing,noEvent,noStyle)
  ,FIELD(timeOff,"Off","ms",0,100,10,1,doNothing,noEvent,noStyle)
  ,OP("Alert",doAlert, enterEvent)
);
